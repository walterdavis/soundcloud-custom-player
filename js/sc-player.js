...
Element.addMethods({
	soundcloud: function(elment){
	  ...
	  $('.sc-time-span')
	    ...
	    .invoke('observe', 'touchstart', function(event) {
...
//working backwards -- got this far today
	  var stopVolumeTracking = function(node, event) {
	    $(node).stopObserving('mousemove','sc-player');
	  };
	  ...
	  document.observe('scPlayer:onVolumeChange', function(event) {
	    $('span.sc-volume-status').setStyle({width: event.volume + '%'});
	  });
	  return element;
	}
